...
/* PROTRACTOR VALUES */
var Users = {
    regeenaAdmin: browser.params.sharedVars.thpAdmin,
    ...
    password: browser.params.sharedVars.thpPassword,
    susanAdmin: 'bill.buse@travelershaven.com',
    susanAdminName: 'Bill Buse',
    password: browser.params.sharedVars.thpPassword,
    amnGlobalAdmin: 'amn-global-1.htcoikvm@mailosaur.io',
    amnGlobalAdminPassword: browser.params.sharedVars.thpPassword,
    amnGlobalAdminName: 'Susan Test User',
    kimAffiliate: 'kimhsunsupplyco@yopmail.com',
    kimAffiliateName: 'Kim Affiliate User',
    kimPassword: browser.params.sharedVars.thpPassword,
    susanAffiliate: 'susansupply' + browser.params.sharedVars.emailDomain,
    susanAffiliateName: 'Susan Affiliate',
    kimAR: 'khultgren@travelershaven.com',
    kimARName: 'Kims Admin User',
    autoTraveler: 'autotraveler' + browser.params.sharedVars.emailDomain,
    autoTravelerName: 'Automation Traveler',
    autoAM: 'autoam' + browser.params.sharedVars.emailDomain,
    autoAMName: 'Automation AM',
    autoTM: 'autotm' + browser.params.sharedVars.emailDomain,
    autoTMName: 'Automation TM',
    kiewitAdmin: 'kiewitadmin' + browser.params.sharedVars.emailDomain,
    kiewitAdminName: 'Kiewit Admin',
    kiewitCoord: 'kiewitcoord' + browser.params.sharedVars.emailDomain,
    kiewitCoordName: 'Kiewit Coord',
    autoClient1Admin: 'autoclient1'  + browser.params.sharedVars.emailDomain,
    autoClient1AdminName: 'auto client1',
    autoAdmin1: 'autoadmin1'  + browser.params.sharedVars.emailDomain,
...
exports.pageHeaders = PageHeaders;
exports.users = Users;
...
exports.leaseOptions = LeaseOptions;
...
exports.ghaVendors = GHAVendors;
exports.lists = Lists;
exports.feesDefault = FeesDefault;
exports.feesCleaning = FeesCleaning;
exports.applicantDavid = ApplicantDavid;
exports.leadStatuses = LeadStatuses;
exports.clientTypes = ClientTypes;
exports.leadSources = LeadSources;
exports.creditCheckTypes = CreditCheckTypes;
exports.clientAccountTabs = ClientAccountTabs;
exports.feesCableService = FeesCableService;
exports.feesInternetService = FeesInternetService;
exports.feesHousekeeping = FeesHousekeeping;
exports.multiplierHousekeeping = MultiplierHousekeeping;
exports.feesUtilities = FeesUtilities;
exports.feesConsumer = FeesConsumer;
exports.optionBadges = OptionBadges;
exports.propertyTypes = PropertyTypes;
exports.ghaSuppliers = GHASuppliers;
exports.revenueShareTypes = RevenueShareTypes;
exports.affiliateOrderStatuses = AffiliateOrderStatuses;
